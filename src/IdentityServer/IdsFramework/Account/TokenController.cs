...
namespace IdentityServer.Quickstart.Account
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        {
            var clientId = "183174195107-ud3u00alnb92q6vn4l54s7stpqbn3n4c.apps.googleusercontent.com";
            var clientSecret = "rm012zhRHzcP8axvgskTNfX5";
        ...
        public async Task<IActionResult> Refresh()
        {
            ...
            var pairs = new Dictionary<string, string>()
                        { 
                            { "client_id", "183174195107-ud3u00alnb92q6vn4l54s7stpqbn3n4c.apps.googleusercontent.com" },
                            { "client_secret", "rm012zhRHzcP8axvgskTNfX5" },
